...
// main executive for Network Workbench project INT 2
//
//---------------------------------------------------------------------------
//
...
// any changes to simulation run profile in pint1.cpp should be inserted here
//
...
//   number_of_hosts_sending_email = 3;      // simplifies traffic for debug
//   link_bit_error_rate = 0;                // stops bit errors for debug
//   multicast = FALSE;                      // turns off multicast
//
